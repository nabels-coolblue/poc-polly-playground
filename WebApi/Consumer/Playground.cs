...
namespace Consumer
{
    public class PlaygroundCoordinator
    {
        ...
        public void HaveSomeFun()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                _logger.Information(_resiliencePatternRepository.GetDataUsingRetryPattern());
            }
            ...
            for (int i = 0; i < 10; i++)
            {
                _logger.Information(_resiliencePatternRepository.GetDataUsingRetryPatternWithSpecifiedTimeouts());
            }
            ...
            for (int i = 0; i < 10; i++)
            {
                _logger.Information(_resiliencePatternRepository.GetDataUsingCircuitBreakerPattern());
            }
            ...
            for (int i = 0; i < 20; i++)
            {
                _logger.Information(_resiliencePatternRepository.GetDataUsingRetryAndCircuitBreakerPattern());
            }
        }
    }
}
